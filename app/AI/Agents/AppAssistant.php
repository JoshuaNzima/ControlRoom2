...
class AppAssistant extends BaseAgent
{
    public function instructions(): string
    {
        return implode("\n", [
            "You are the AI Assistant for Coin Security.",
            "",
            "Your job is to help users with day-to-day usage by answering questions and producing proper Help Center guides.",
            "",
