...
export default function LoyaltyDashboard({
  ...
  return (
    <AuthenticatedLayout header="Loyalty Points">
          ...
          <Card className="p-8 text-center">
            <div className="flex flex-col items-center gap-4">
              <div className="p-4 bg-amber-100 dark:bg-amber-900/20 rounded-full">
                <IconMapper name="Gift" size={32} className="text-amber-600 dark:text-amber-400" />
              </div>
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                  Redemption and loyalty actions have been turned off by the admin.
                </p>
              </div>
            </div>
          </Card>
                ...
                {availableRewards.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    {availableRewards.map((reward) => {
                      ...
                      const remaining = reward.quantity_available
