        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href={route('control-room.shifts.index')} className="text-sm text-coin-700 hover:text-coin-800 dark:text-coin-300 dark:hover:text-coin-200">Back</Link>
            </div>
          </CardHeader>
          <CardContent>
            ...
            {!shift.is_global && (
              <div className="text-sm text-gray-500 dark:text-gray-400">Sites: {Array.isArray(shift.sites) ? shift.sites.join(', ') : ''}</div>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          ...
          <CardContent>
            <div className="space-y-2">
              {shift.guards?.length === 0 && <div className="text-sm text-gray-500 dark:text-gray-400">No guards assigned.</div>}
