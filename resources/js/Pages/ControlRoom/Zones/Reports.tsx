            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {stats?.map((s: any, idx: number) => (
                <div key={idx} className="p-3 rounded border dark:border-gray-600">
                  ...
                  <div className="text-sm text-gray-900 dark:text-gray-100">Coverage: <span className="font-semibold">{s.coverage_rate}%</span></div>
                  <div className="text-sm text-gray-900 dark:text-gray-100">Attendance: <span className="font-semibold">{s.attendance_rate}%</span></div>
