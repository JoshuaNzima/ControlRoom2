      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-6">
            ...
            <div className="p-4">
              <div className="flex items-center">
                <div className="flex-shrink-0 p-3 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                  <IconMapper name="Package" className="w-6 h-6 text-blue-600 dark:text-blue-300" />
                </div>
                <div className="ml-4">
          ...
          <Card>
            <div className="p-4">
              <div className="flex items-center">
                <div className="flex-shrink-0 p-3 bg-purple-100 dark:bg-purple-900/30 rounded-full">
                  <IconMapper name="Star" className="w-6 h-6 text-purple-600 dark:text-purple-300" />
                </div>
                <div className="ml-4">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 shadow">
          <div className="p-6">
            <h2 className="text-lg font-semibold mb-6 text-gray-900 dark:text-gray-100">Add New Service</h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        <Button onClick={() => saveEdit(service.id)} className="w-full sm:w-auto bg-green-600 hover:bg-green-700">Save</Button>
                        <Button onClick={() => setEditingId(null)} variant="outline" className="w-full sm:w-auto">Cancel</Button>
                      </div>
                    </div>
                  </div>
                ) : (
