        ...
        <form onSubmit={submit} className="px-6 py-4 grid grid-cols-1 gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" step="0.01" required className="w-full border rounded-md p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100" value={data.liters} onChange={(e) => setData('liters', e.target.value)} />
            </div>
            <div>
