...
export default function DownsIndex() {
  ...
  function submit(e: React.FormEvent) {
    e.preventDefault();
    post(route('operations.control-room.downs.store'), {
      onSuccess: () => reset(),
    });
  }

  function escalate(id: number) {
    router.post(route('operations.control-room.downs.escalate', id));
  }

  function resolve(id: number) {
    router.post(route('operations.control-room.downs.resolve', id));
  }
