      ...
      <div className="space-y-4">
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href={route('operations.control-room.clients')} className="text-sm text-indigo-600">Back</Link>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent>
              <form className="flex gap-2 items-end" onSubmit={(e) => { e.preventDefault(); guardForm.post(route('operations.control-room.clients.assign-guard', client.id)); }}>
          ...
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent>
              <form className="flex gap-2 items-end" onSubmit={(e) => { e.preventDefault(); supervisorForm.post(route('operations.control-room.clients.assign-supervisor', client.id)); }}>
                <div className="flex-1">
