...
const CameraShow = ({ camera, recentRecordings, activeAlerts }) => {
    ...
    const handleRecordingToggle = () => {
        router.post(route('operations.control-room.cameras.recordings.toggle', camera.id), {
            onSuccess: () => {
    ...
    const handleDownloadRecording = (recordingId) => {
        window.location.href = route('operations.control-room.cameras.recordings.download', recordingId);
    };

    const handleAcknowledgeAlert = (alertId) => {
        router.post(route('operations.control-room.cameras.alerts.acknowledge', alertId));
    };
                                        ...
                                        <div className="p-4 flex justify-between items-center">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                {camera.recording_enabled && (
                                                    <Badge variant="outline">
                                                        {camera.retention_days} Days Retention
                                                    </Badge>
                                                )}
                                            </div>
                                        </div>
