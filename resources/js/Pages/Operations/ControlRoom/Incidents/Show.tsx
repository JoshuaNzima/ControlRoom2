...
const ShowIncident = ({ auth, incident }: ShowIncidentProps) => {
  ...
  const handleEscalate = () => {
    router.post(route('operations.control-room.incidents.escalate', incident.id));
  };

  const handleResolve = () => {
    router.post(route('operations.control-room.incidents.resolve', incident.id));
  };
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <div className="flex space-x-2">
              <Link href={route('operations.control-room.incidents.edit', incident.id)}>
