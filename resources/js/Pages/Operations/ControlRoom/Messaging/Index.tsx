...
const MessagingIndex = ({ auth, conversations, agents }: MessagingIndexProps) => {
    ...
    useEffect(() => {
        ...
        try {
            const ch = (echo as any).private ? (echo as any).private('emergencies') : (echo as any).channel('emergencies');
            ch.listen('EmergencyAlert', (e: any) => {
        ...
        return () => {
            try {
                if ((echo as any).leave) (echo as any).leave('emergencies');
            } catch (e) {
    ...
    const handleAgentClick = (agent: Agent) => {
        router.post(route('operations.control-room.messaging.store'), {
            type: 'direct',
