...
export default function ShiftsEdit() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('operations.control-room.shifts.update', shift.id));
  };
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href={route('operations.control-room.shifts.show', shift.id)} className="text-sm text-indigo-600">Back</Link>
            </div>
          </CardHeader>
          <CardContent>
