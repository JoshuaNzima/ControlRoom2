        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href={route('operations.control-room.shifts.index')} className="text-sm text-indigo-600">Back</Link>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-2">
              ...
              {shift.guards?.map((g: any) => (
                <div key={g.id} className="flex items-center justify-between p-3 border rounded-md dark:border-gray-600">
                  ...
                  <Link href={route('operations.control-room.shifts.unassign', [shift.id, g.id])} method="post" as="button" className="text-sm text-red-600">Unassign</Link>
                </div>
              ))}
            </div>
          </CardContent>
