...
export default function CreateBudget({ categories, currentYear }: Props) {
  ...
  return (
    <AdminLayout title="Create Budget">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                {errors.fiscal_month && (
                  <p className="mt-1 text-sm text-red-600">{errors.fiscal_month}</p>
                )}
              </div>
