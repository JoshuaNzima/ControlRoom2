...
export default function PettyCashIndex({ entries, balance, stats, category_breakdown, categories, filters }: PettyCashProps) {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
                        <Wallet className="w-6 h-6 text-coin-500" />
                    ...
                    <DialogContent className="bg-background border-border text-foreground max-w-md">
                        <DialogHeader>
                            <DialogTitle className="flex items-center gap-2">
                                <Wallet className="w-5 h-5 text-coin-500" />
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className={cn(
                                    "text-2xl font-bold",
                                    balance.current >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"
                                )}>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{formatCurrency(stats.monthly_replenished)}</p>
                            </div>
            ...
            {category_breakdown.length > 0 && (
                <Card className="bg-card border-border mb-6">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm text-muted-foreground">Monthly Expenses by Category</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="flex flex-wrap gap-2">
                            {category_breakdown.map((cat) => (
                                ...
                                >
                                    {cat.label}: {formatCurrency(cat.total)}
                                </Badge>
                            ))}
                        </div>
                    </CardContent>
