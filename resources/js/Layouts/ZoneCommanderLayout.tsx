			...
			>
				...
				<div className="p-4 border-t border-red-800 dark:border-gray-800">
					<button
						...
						className="w-full flex items-center justify-center gap-2 bg-white text-red-900 hover:bg-red-50 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700 py-3 px-4 rounded-lg shadow-md transition-all font-semibold"
					>
