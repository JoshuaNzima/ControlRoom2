...
export default function FrontDeskLayout({ title, children, user }: Props) {
  ...
  const nav: NavItem[] = [
    ...
    { name: 'Tickets', href: route('admin.front-desk.tickets.index'), icon: <IconMapper name="ticket" className="h-6 w-6" />, current: isCurrent(route('admin.front-desk.tickets.index')) },
