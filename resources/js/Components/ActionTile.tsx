...
export const ActionTile: React.FC<ActionTileProps> = ({ icon, title, description, href, color, onClick }) => {
  const content = (
    <>
  ...
  const className = `group relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 
    bg-white dark:bg-gray-800 p-5 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 block`;
