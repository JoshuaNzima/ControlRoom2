...
export default function QuickRequisitionButton({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Transform data before submission using Inertia's transform method
    transform((data) => {
      if (multiItemMode) {
        return { ...data, items: data.items.filter(i => i.description.trim()) };
      } else {
        // Simple mode: create a single item from the total amount
        return {
          ...data,
          items: [{
  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center justify-center rounded-md bg-red-600 px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-red-600/20 transition-all hover:bg-red-700 hover:shadow-red-600/30 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-60 ${className}`}
      >
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 max-h-[85vh] overflow-y-auto">
          <div className="mb-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800/60 rounded-lg p-1">
                <button
                  type="button"
                  onClick={() => setMultiItemMode(false)}
                  className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${!multiItemMode ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'}`}
                >
                  Simple
                </button>
                <button
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <input
                  id="req-title"
                  name="title"
                  className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100"
                  value={data.title}
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-gray-700 dark:text-gray-300">Needed by</label>
                <input
                  id="req-needed-by"
                  name="needed_by"
                  type="date"
              ...
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <textarea
                  id="req-description"
                  name="description"
                  className="min-h-[60px] w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100"
            ...
            {!multiItemMode && (
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-gray-700 dark:text-gray-300">Amount (MWK) *</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    placeholder="0.00"
                    className="w-full rounded-lg border border-gray-300 bg-white pl-10 pr-3 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100"
                    value={data.amount}
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={addItem}
                    className="inline-flex items-center gap-1 rounded-md bg-red-600/10 px-2.5 py-1.5 text-xs font-medium text-red-600 hover:bg-red-600/20 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20"
                  >
                  ...
                  {data.items.map((item, index) => (
                    ...
                    >
                      ...
                      {item.amount && parseFloat(item.amount) > 0 && (
                        <p className="mt-1 text-xs text-right text-gray-600 dark:text-gray-400">
            ...
            {/* Total */}
            {totalAmount > 0 && (
              <div className="flex items-center justify-between rounded-lg bg-red-600/5 border border-red-600/10 p-3 dark:bg-red-500/5 dark:border-red-500/10">
            ...
            <div className="space-y-1.5 pt-2">
              <label className="text-xs font-semibold text-gray-700 dark:text-gray-300">Attachments (optional)</label>
              <input
                type="file"
                multiple
          ...
          <div className="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end pt-4 border-t border-gray-200 dark:border-gray-800">
            <button
              type="button"
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-red-700 disabled:opacity-60"
            >
